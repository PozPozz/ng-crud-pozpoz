...
export const EMPLOYEES: PositionListItem[] = [
    ...
    { id: 10, name: 'Federica', surname: 'Bongiovi', positionCovered: 'Social Media Manager', busyOnTask: false },
    ...
    { id: 23, name: 'Gabriele', surname: 'Di Stefano', positionCovered: 'HR', busyOnTask: false },
